...
abstract class Deque[A] {
  def prepend(data:A) //should add a single element to the logical "beginning" of the Deque
  def append(data:A) //should add a single element to the logical "end" of the Deque
